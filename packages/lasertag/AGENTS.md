...
- Refractor (`lasertag/refractor`) compares a TSX or Astro render story with its sibling CSS Module. Use the API for custom analysis; unknown paths are not dead CSS.
